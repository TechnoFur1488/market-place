...
export const CardProduct: React.FC<CardProductProps> = ({ isImgProduct, isNameProduct, isPriceProduct, isDiscountProduct }) => {
    ...
    return (
        <div className="flex flex-col justify-between w-[216px] h-[435px]">
            <Link to={"/"} className="flex flex-col justify-between h-[370px]">
